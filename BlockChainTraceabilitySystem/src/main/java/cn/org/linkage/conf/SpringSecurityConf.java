...
//
//import cn.org.linkage.service.UserService;
//import cn.org.linkage.utils.SystemPasswordEncoder;
...
//                */
//
//        //以下为自定义的用于测试登录授权分权限验证的例子，使用inMemoryAuthentication写入内存，实际上以数据库查询为主
...
//
//        //以下为数据库查询
//        auth.userDetailsService(userService).passwordEncoder(new SystemPasswordEncoder());
//
//    }
//
//
